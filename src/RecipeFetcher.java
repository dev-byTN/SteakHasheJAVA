...
public class RecipeFetcher {
            ...
            if (connection.getResponseCode() == 200) {
                ...
                if (recipeResponse != null && recipeResponse.getRecipes() != null) {
                    for (Recipe recipe : recipeResponse.getRecipes()) {
                        ...
                        System.out.println("Emoji: " + recipe.getEmoji());
                        System.out.println("Default Points: " + recipe.getDefaultPoints());
                        System.out.println("Ingredients:");
                        if (recipe.getIngredients() != null && !recipe.getIngredients().isEmpty()) {
                            for (Ingredients ingredient : recipe.getIngredients()) {
                                // Ingredients processing can be logged if needed.
                                System.out.println("  - Ingredient ID: " + ingredient.getId() + ", Emoji: " + ingredient.getEmoji());
                            }
                        }
                ...
                if (recipeDetails.getSteps() != null) {
                    for (Step step : recipeDetails.getSteps()) {
                        if (step.getArgumentsValues() != null) {
                            System.out.println("Step arguments: " + step.getArgumentsValues());
    ...
    public static void main(String[] args) {
        ...
        System.out.println(recipeArg.fetchAndDisplayRecipes()); // Fetch and display all recipes.
        System.out.println(recipeArg.getArg(4)); // Example usage to get a specific argument.
    }
}
